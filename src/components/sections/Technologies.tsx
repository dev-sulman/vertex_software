        ...
        <section className="relative py-32 px-6 bg-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10 text-center">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white text-[#11aff9] shadow-xl shadow-blue-500/10 mb-8 border border-slate-200"
                >
                ...
                >
                    Built with a <span className="text-[#11aff9]">Future-Proof</span> <br className="hidden md:block" />
                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                        <button className="group relative px-12 py-5 rounded-full bg-[#11aff9] text-white font-medium text-lg overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(37,99,235,0.2)] active:scale-95">
