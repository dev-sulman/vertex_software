    ...
    return (
        <section className="relative py-32 px-6 bg-white overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-1/4 -left-1/4 w-[50%] h-[50%] bg-[#0557A0]/5 blur-[120px] rounded-full" />
            ...
            <div className="max-w-7xl mx-auto relative z-10 text-center">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white text-[#0557A0] shadow-xl shadow-blue-500/10 mb-8 border border-slate-200"
                >
                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                        <button className="group relative px-12 py-5 rounded-full bg-[#0557A0] text-white font-medium text-lg overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(37,99,235,0.2)] active:scale-95">
