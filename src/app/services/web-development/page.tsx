...
import { ArrowRight, Globe, CheckCircle2, Code2, Rocket, Search, Cpu, ShieldCheck, ChevronDown } from "lucide-react"
    ...
    return (
        <main className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-500 mb-10 max-w-2xl leading-relaxed">
                            We build blazing-fast, SEO-optimized, and visually stunning websites that convert visitors into loyal customers. Leveraging the latest frameworks like Next.js and React.
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed font-light">
                                Your website is your digital storefront. We don't just write code; we architect digital experiences that align with your brand identity and business objectives, ensuring perfect performance across all devices.
                            </p>
            ...
            <section className="py-24 px-6 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-medium text-slate-900 mb-4">Our Development Process</h2>
                        <p className="text-slate-500 max-w-2xl mx-auto">A systematic approach to building high-quality web solutions.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            { step: "01", title: "Discovery", desc: "Understanding your goals and audience." },
                            { step: "02", title: "Strategy", desc: "Architecture and design planning." },
                            { step: "03", title: "Development", desc: "Agile coding and regular updates." },
            ...
            <section className="py-24 px-6 bg-slate-900 text-white overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-medium mb-4">Future-Proof Technologies</h2>
                        <p className="text-blue-200/60 max-w-2xl mx-auto">We use the best tools to ensure your product leads the market.</p>
                    </div>

                    <div className="flex flex-wrap justify-center gap-12 opacity-50">
                        {["Next.js", "React", "TypeScript", "Tailwind CSS", "Node.js", "GraphQL", "PostgreSQL", "AWS"].map((tech) => (
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {[
                            { q: "How long does it take to build a website?", a: "A standard business website typically takes 4-8 weeks, while complex web applications can take 3-6 months depending on requirements." },
                            { q: "Will my website be mobile-friendly?", a: "Yes, 100%. We follow a mobile-first design approach, ensuring your site looks and works perfectly on all screen sizes." },
                            { q: "Do you offer post-launch support?", a: "Absolutely. We provide ongoing maintenance, security updates, and performance optimization to keep your site running smoothly." },
                            { q: "Can you help with SEO?", a: "Yes, we integrate technical SEO best practices into the core of your website during development to help you rank higher from day one." }
                        ].map((faq, i) => (
